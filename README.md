...
1. Откроется блокнот с новыми хостами и проводник где находиться сам хост файл.
2. Скопируйте весь текст из открывшегося блокнота.
3. Откройте файл hosts в появившейся папке с помощью текстового редактора (легче всего с помощью [Np++](https://notepad-plus-plus.org/downloads/)) Важно, запустить его от имени администратора.
4. Добавьте в конец файла hosts то, что скопировали (или замените, если до этого Вы уже добавляли подобное)
